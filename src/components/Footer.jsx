...
const Footer = () => {
  return (
    <footer className="bg-[#383838] ">
      <div className="max-w-[1200px] px-10 mx-auto py-20">
        <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 lg:gap-16 gap-10">
          <div className="space-y-4">
            ...
            <div className="flex gap-5">
              <Link
                className="bg-[#0866FF] p-1 border border-[#0866FF] rounded-2xl"
                href="#"
              >
                <FaSquareFacebook />
              </Link>
              ...
              <Link
                className="bg-black p-1 border border-black rounded-2xl"
                href="#"
              >
                <FaSquareXTwitter />
              </Link>
              ...
              <Link
                className="bg-[#0A66C2] p-1 border border-[#0A66C2] rounded-2xl"
                href="#"
              >
                <FaLinkedinIn />
              </Link>
        ...
        <div className="text-center text-xs lg:mt-4 mt-7">
